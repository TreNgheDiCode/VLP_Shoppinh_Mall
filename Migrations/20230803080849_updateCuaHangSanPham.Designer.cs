...
namespace VLPMall.Migrations
{
    ...
    [Migration("20230803080849_updateCuaHangSanPham")]
    partial class updateCuaHangSanPham
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VLPMall.Models.CuaHangSanPham", b =>
                {
                    b.Property<int>("MaCuaHang")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VLPMall.Models.CuaHangSanPham", b =>
                {
                    b.HasOne("VLPMall.Models.CuaHang", "CuaHang")
                        .WithMany("CuaHangSanPhams")
                        .HasForeignKey("MaCuaHang")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("VLPMall.Models.SanPham", "SanPham")
                        .WithMany("CuaHangSanPhams")
